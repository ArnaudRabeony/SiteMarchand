...
<div id="connectionContainer" class="col-md-offset-2">
	<div id="connectionContent" class="row">
		...
		<form action="index.php?page=check_co" method="post" class="col-md-5 col-sm-3" novalidate>
...
<p class="errormessage" style="color:red"><?php echo $errorMessage; ?></p>
		...
		<a href="index.php?page=createAccount">Vous n'avez pas encore de compte ?</a>
</div>
